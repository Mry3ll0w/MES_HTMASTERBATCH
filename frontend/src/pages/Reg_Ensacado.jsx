...
export default function RegEnsacado({ LoggedUser }) {
  ...
  function UpdateEnsacado() {
    ...
    if (isNaN(M_Cantidad) === true) {
      ...
      cerror(true);
      alert(
        "La Cantidad no puede ser un valor no numerico, si es un número decimal usa . en vez de ,"
      );
    } else cerror(false);
  ...
  function InsertaEnsacado() {
    ...
    if (isNaN(M_Cantidad) === true) {
      ...
      cerror(true);
      alert(
        "La Cantidad no puede ser un valor no numerico ni tener comas, si es un decimal usa . en vez de ,"
      );
    } else cerror(false);
